...
textChunk1:
  titleSection: Il modello di sito
  subtitleSection: Il principale punto di contatto tra la PA e i cittadini
  iconSection: '/assets/icons/kit/modelli.svg'
  title: A COSA SERVE
  text: "<p>Il modello permette di creare siti web comunali che rispondono ai bisogni degli utenti, con interfacce e strutture informative semplici da usare e navigare. Lo scopo è di fornire ai cittadini un solido punto di riferimento per trovare con facilità tutte le informazioni di cui hanno bisogno per la vita di tutti i giorni.</p>
  <p>L’adozione del modello di sito permette di aderire alle Linee guida di design per i siti internet e i servizi digitali della PA, fornendo un’esperienza coerente tra le varie amministrazioni e facilitandone l’uso per i cittadini che si spostano tra vari comuni.</p>
