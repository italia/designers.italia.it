		...
		<div id={data.nav.id}>
			<nav className="" aria-label={data.nav.ariaLabel}>
				<div className="it-header-slim-wrapper p-0 h-100">   
					<div className="header-pre bg-white py-4 border-bottom border-200 /*shadow*/">
									...
									<ul className="list-inline mb-0 d-flex flex-column flex-md-row">
										{data.nav.items.map((value,index)=>{
											if (index + 1 === data.nav.items.length) { // last on the left side has "me-auto"
												styles="list-item me-md-auto mb-3 mb-md-0 align-self-center"
											} else {
												styles="list-item me-md-5 mb-3 mb-md-0 align-self-center"
											}
											return(
										...
										<li key={"banner-item-"+countItems+1} className="list-item mb-1 mb-md-0 mt-3 mt-md-0 align-self-center">
											<a
